...
export default function WithOffsetImage() {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate overflow-hidden bg-linear-to-b from-emerald-100/20 pt-14">
        <div
          aria-hidden="true"
          className="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-white shadow-xl ring-1 shadow-emerald-600/10 ring-emerald-50 sm:-mr-80 lg:-mr-96"
        />
