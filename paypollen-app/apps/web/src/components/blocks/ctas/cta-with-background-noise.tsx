...
export function CTAWithBackgroundNoise() {
  return (
    <section className="w-full grid grid-cols-1 md:grid-cols-2 my-20 md:my-40 justify-start relative z-20 max-w-7xl mx-auto bg-gradient-to-br from-slate-800 dark:from-neutral-900 to-gray-900 sm:rounded-2xl">
      ...
      <div className="absolute -top-px right-10 md:right-40 bg-gradient-to-r from-transparent via-emerald-500 h-px to-transparent w-1/2 z-30"></div>
      ...
      <div className="absolute -bottom-px right-10 md:right-40 bg-gradient-to-r from-transparent via-emerald-500 h-px to-transparent w-1/2 z-30"></div>
