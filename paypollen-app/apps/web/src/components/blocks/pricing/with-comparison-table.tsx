              ...
              <a
                ...
                className={classNames(
                  tier.mostPopular
                    ...
                    : 'text-emerald-600 ring-1 ring-emerald-200 ring-inset hover:ring-emerald-300',
                  'mt-8 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600',
                )}
              >
                Buy plan
              </a>
                          ...
                          <li key={feature.name} className="flex gap-x-3">
                            ...
                            <span>
                              ...
                              {typeof feature.tiers[tier.name as keyof typeof feature.tiers] as string === 'string' ? (
                                <span className="text-sm/6 text-gray-500">({feature.tiers[tier.name as keyof typeof feature.tiers]})</span>
                              ) : null}
                            </span>
                          </li>
                        ) : null,
                      ...
                      <tr key={feature.name}>
                        ...
                        {tiers.map((tier) => (
                          <td key={tier.id} className="px-6 py-4 xl:px-8">
                            {typeof feature.tiers[tier.name as keyof typeof feature.tiers] as string === 'string' ? (
                              <div className="text-center text-sm/6 text-gray-500">{feature.tiers[tier.name as keyof typeof feature.tiers]}</div>
                            ) : (
                              <>
