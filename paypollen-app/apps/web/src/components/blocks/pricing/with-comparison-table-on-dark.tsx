                          ...
                          <li key={feature.name} className="flex gap-x-3">
                            ...
                            <span>
                              ...
                              {typeof feature.tiers[tier.name as keyof typeof feature.tiers] as string === 'string' ? (
                                <span className="text-sm/6 text-gray-400">({feature.tiers[tier.name as keyof typeof feature.tiers]})</span>
                              ) : null}
                            </span>
                          </li>
                        ) : null,
                  ...
                  {tiers.map((tier) => (
                    <td key={tier.id} className="px-6 pt-2 xl:px-8">
                      ...
                      <a
                        ...
                        className={classNames(
                          tier.mostPopular
                            ? 'bg-emerald-500 hover:bg-emerald-400 focus-visible:outline-emerald-600'
                      ...
                      <tr key={feature.name}>
                        ...
                        {tiers.map((tier) => (
                          <td key={tier.id} className="px-6 py-4 xl:px-8">
                            {typeof feature.tiers[tier.name as keyof typeof feature.tiers] as string === 'string' ? (
                              <div className="text-center text-sm/6 text-gray-300">{feature.tiers[tier.name as keyof typeof feature.tiers]}</div>
                            ) : (
                              <>
                                {feature.tiers[tier.name as keyof typeof feature.tiers] === true ? (
                                  <CheckIcon aria-hidden="true" className="mx-auto size-5 text-emerald-400" />
                                ) : (
