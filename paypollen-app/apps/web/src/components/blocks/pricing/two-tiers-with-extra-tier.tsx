          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
              {tiers.map((tier) => (
                ...
                >
                  <div>
                    <h3 id={tier.id} className="text-base/7 font-semibold text-emerald-600">
                      {tier.name}
                    </h3>
                  ...
                  <a
                    ...
                    className="mt-8 block rounded-md bg-emerald-600 px-3.5 py-2 text-center text-sm/6 font-semibold text-white shadow-xs hover:bg-emerald-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600"
                  >
                    Get started today
                  </a>
                </div>
              ...
              <div className="flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl p-8 ring-1 ring-gray-900/10 sm:gap-y-10 sm:p-10 lg:col-span-2 lg:flex-row lg:items-center">
                <div className="lg:min-w-0 lg:flex-1">
                  <h3 className="text-base/7 font-semibold text-emerald-600">Discounted</h3>
                ...
                <a
                  href="#"
                  className="rounded-md px-3.5 py-2 text-sm/6 font-semibold text-emerald-600 ring-1 ring-emerald-200 ring-inset hover:ring-emerald-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600"
                >
