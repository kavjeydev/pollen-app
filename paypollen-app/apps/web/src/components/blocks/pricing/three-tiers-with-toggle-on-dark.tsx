        ...
        <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {tiers.map((tier) => (
            <div
              ...
              className="group/tier rounded-3xl p-8 ring-1 ring-white/10 data-featured:bg-white/5 data-featured:ring-2 data-featured:ring-emerald-500 xl:p-10"
            >
              <div className="flex items-center justify-between gap-x-4">
                <h3 id={`tier-${tier.id}`} className="text-lg/8 font-semibold text-white">
                  {tier.name}
                </h3>
                <p className="rounded-full bg-emerald-500 px-2.5 py-1 text-xs/5 font-semibold text-white group-not-data-featured/tier:hidden">
                  Most popular
                </p>
              </div>
              ...
              <button
                ...
                className="mt-6 block w-full rounded-md bg-white/10 px-3 py-2 text-center text-sm/6 font-semibold text-white group-data-featured/tier:bg-emerald-500 group-data-featured/tier:text-white group-data-featured/tier:shadow-xs hover:bg-white/20 group-data-featured/tier:hover:bg-emerald-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white group-data-featured/tier:focus-visible:outline-emerald-500"
              >
                Buy plan
              </button>
